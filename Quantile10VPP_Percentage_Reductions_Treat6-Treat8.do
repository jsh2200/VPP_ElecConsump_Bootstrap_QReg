...
version 12;           * tell Stata to use version 13, so that code will still work in future versions;
...
collapse (first) ac_indicator bsdewp_1 bsdewp_2 bsdewp_3 bsdewp_4 bstemp_1 bstemp_2 bstemp_3 bstemp_4 day dewp hr_weekday id
...
gen clusterGroup = 0;
replace clusterGroup = 1 if Zip == 73072 | Zip == 73026 | Zip == 73170 | Zip == 73165;
replace clusterGroup = 2 if Zip == 73120 | Zip == 73132 | Zip == 73069 | Zip == 73070 | Zip == 73071 | Zip == 74857 ;
replace clusterGroup = 3 if Zip == 73160 | Zip == 73107 | Zip == 73159;
...
forval VPPindex = 2/4 {;
	forval tt=0/23 {;
		...
		eststo:  qreg2 logkwh treat6 treat7 treat8 bstemp_* bsdewp_* if hour==`tt' & VPPDay == `VPPindex', quantile(`quant') cluster(identity) ;
