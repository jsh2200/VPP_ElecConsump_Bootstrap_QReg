...
Zip == 73132 | Zip == 73159 | Zip == 73165 | Zip == 74857;
gen logkwh = 0;
...
clear all;
	...
	* collapse (first) identity meterid age income VPPDay (sum) measuredkwh Consumptionkwh_treat6
	...
	* sort accountid VPPDay; 
	
	* by accountid VPPDay: egen averageSavingsPercentage_treat6 = mean(SavingsPercentage_treat6);
	* by accountid VPPDay: egen averageSavingsPercentage_treat7 = mean(SavingsPercentage_treat7);
	* by accountid VPPDay: egen averageSavingsPercentage_treat8 = mean(SavingsPercentage_treat8);
...
collapse (first) identity meterid age income VPPDay (sum) measuredkwh ConsumptionChangekwh_treat6
